...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let circleBulb = ImageAsset(name: "circle_bulb")
    internal static let circleCoin = ImageAsset(name: "circle_coin")
    internal static let circleLeaf = ImageAsset(name: "circle_leaf")
    internal static let leaf = ImageAsset(name: "leaf")
    internal static let profile = ImageAsset(name: "profile")
    internal static let tree1 = ImageAsset(name: "tree1")
